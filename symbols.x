...
FUN_0202aaec = 0x0202aaec;


STAR_ID_SELECTED = 0x0209f1f0;
PREVIOUS_LEVEL_ID = 0x0209211c;
RETURN_ENTRANCE_ON_DEAH = 0x0209f200;
LEVEL_ID_TO_LOAD = 0x02092110;


FUN_0202ded4 = 0x0202ded4;

FUN_0202d690 = 0x0202d690;

CURRENT_LEVEL_OVERLAY = 0x02092130;
OS_Terminate = 0x02019740;
DAT_0209f278 = 0x0209f278;
FS_loadOverlay = 0x02018028;
FUN_0202df70 = 0x0202df70;

FS_LoadOverlayInfo = 0x02018c00;
FS_GetOverlayFileID  = 0x0205e088;

FS_Internal_readFile = 0x02018d48;
DAT_0209f340 = 0x0209f340;
RAM_ADDRESS_LEVELS = 0x02092208;